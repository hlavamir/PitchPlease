...
//
#line 862 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_0cc2d7656756f7383e659b0fd4ca6790.hlsl"
...
@G    Pixel => aaf18e3794bcb130d59e7c54fcffa257
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 929 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_0cc2d7656756f7383e659b0fd4ca6790.hlsl"
...
#line 419
      ishl r6.w, r7.y, l(2)
      imad r6.w, r5.w, l(4), r6.w
      iadd r6.w, r6.w, l(4)
      dp4 r9.x, r2.xyzw, cb2[r6.w + 31].xyzw  // r9.x <- shadowPosition.x
      dp4 r9.y, r2.xyzw, cb2[r6.w + 32].xyzw  // r9.y <- shadowPosition.y
      dp4 r7.y, r2.xyzw, cb2[r6.w + 33].xyzw  // r7.y <- shadowPosition.z
      dp4 r2.x, r2.xyzw, cb2[r6.w + 34].xyzw  // r2.x <- shadowPosition.w

#line 420
      add r9.z, r7.y, -cb2[r1.w + 135].x  // r9.z <- shadowPosition.z
...
#line 543
  else   // Prior locations: r7.y <- cascadeIndexBase; r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z; r4.x <- splitDist
    mov r8.xyz, r7.zzzz  // r8.x <- shadow.x; r8.y <- shadow.y; r8.z <- shadow.z
  endif 

#line 549
  mul r2.xyz, r8.xyzx, icb[r5.w + 0].xyzx  // r2.x <- <ComputeShadow_id47 return value>.x; r2.y <- <ComputeShadow_id47 return value>.y; r2.z <- <ComputeShadow_id47 return value>.z

#line 643
  mul r2.xyz, r2.xyzx, cb2[r7.x + 27].xyzx
...
const static bool TCascadeDebug_id163 = true;
