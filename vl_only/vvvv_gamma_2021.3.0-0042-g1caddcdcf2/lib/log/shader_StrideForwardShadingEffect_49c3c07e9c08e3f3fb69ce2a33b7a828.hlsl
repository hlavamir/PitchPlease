...
@R    LightClusters_id177 => LightClustered.LightClusters [Stage: Pixel, Slot: (1-1)]
@R    LightIndices_id178 => LightClustered.LightIndices [Stage: Pixel, Slot: (2-2)]
@R    PointLights_id182 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (3-3)]
@R    SpotLights_id183 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (4-4)]
...
//
#line 920 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_49c3c07e9c08e3f3fb69ce2a33b7a828.hlsl"
...
@G    Pixel => b3a417a59639e63371a73a49d60b7c16
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// LightClusters_id177               texture   uint2          3d             t1      1 
// LightIndices_id178                texture    uint         buf             t2      1 
// PointLights_id182                 texture  float4         buf             t3      1 
// SpotLights_id183                  texture  float4         buf             t4      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 987 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_49c3c07e9c08e3f3fb69ce2a33b7a828.hlsl"
...
#line 396
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.x, r4.xyxx, t0.xxxx, s0, r4.z  // r4.x <- <FilterShadow_id59 return value>
...
#line 532
    iadd r4.y, r0.w, l(-1)
    add r4.y, -cb2[r4.y + 99].x, cb2[r0.w + 99].x  // r4.y <- splitSize

#line 533
  else 
    mov r4.y, cb2[r0.w + 99].x  // r4.y <- splitSize
  endif 

#line 534
  add r0.w, -v2.x, cb2[r0.w + 99].x
  div r0.w, r0.w, r4.y  // r0.w <- splitDist

#line 535
  lt r4.y, r0.w, l(0.200000)
  if_nz r4.y
...
#line 540
      mov r4.yzw, r4.xxxx  // r4.y <- shadow.x; r4.z <- shadow.y; r4.w <- shadow.z
    else 
...
#line 396
      sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t0.xxxx, s0, r2.z  // r1.w <- <FilterShadow_id59 return value>
...
#line 496
mov r2.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r2.xyzw, t1.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
#line 588
mul r0.xyz, cb1[0].xyzx, cb2[104].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id181 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id181 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id181 return value>.z
...
void ProcessLight_id88(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = ComputeAttenuation_id87(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id74(light, streams.PositionWS_id22.xyz, lightVectorNorm);
...
void ResetStream_id107()
{
}
void AfterLightingAndShading_id188()
{
}
void PrepareEnvironmentLight_id177(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id47 = 0;
    streams.envLightSpecularColor_id48 = 0;
}
float3 ComputeEnvironmentLightContribution_id181(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id180(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
int GetLightCount_id119()
{
    return LightCount_id86;
}
int GetMaxLightCount_id120()
{
...
void PrepareForLightingAndShading_id185()
{
}
void PrepareMaterialForLightingAndShading_id106(inout PS_STREAMS streams)
{
...
void ResetLightStream_id105(inout PS_STREAMS streams)
{
...
void ResetStream_id108(inout PS_STREAMS streams)
{
    ResetStream_id107();
...
void Compute_id222(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id105(streams);
    PrepareMaterialForLightingAndShading_id106(streams);

    {
        PrepareForLightingAndShading_id185();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id115();
        const int maxLightCount = GetMaxLightCount_id120();
        int count = GetLightCount_id119();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id180(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id181(streams);
        }
    }

    {
        PrepareEnvironmentLight_id177(streams);
    ...
    {
        AfterLightingAndShading_id188();
    }
}
void Compute_id206(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id178();
    streams.matDiffuse_id53 = colorBase;
    streams.matColorBase_id52 = colorBase;
}
void ResetStream_id109(inout PS_STREAMS streams)
{
    ResetStream_id108(streams);
