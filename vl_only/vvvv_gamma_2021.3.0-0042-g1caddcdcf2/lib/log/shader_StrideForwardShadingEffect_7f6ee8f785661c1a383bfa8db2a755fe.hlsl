...
//
#line 1063 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_7f6ee8f785661c1a383bfa8db2a755fe.hlsl"
...
@G    Pixel => 096f92214b9308061c03c6697622bd30
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1130 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_7f6ee8f785661c1a383bfa8db2a755fe.hlsl"
...
#line 473
      ...
      dp4 r12.w, r6.xyzw, cb2[r5.w + 33].xyzw  // r12.w <- shadowPosition.z
      dp4 r5.w, r6.xyzw, cb2[r5.w + 34].xyzw  // r5.w <- shadowPosition.w

#line 474
      add r14.z, r12.w, -cb2[r3.w + 135].x  // r14.z <- shadowPosition.z
...
#line 648
  else   // Prior locations: r5.w <- cascadeIndexBase; r6.x <- shadowPosition.x; r6.y <- shadowPosition.y; r6.z <- shadowPosition.z; r12.w <- splitDist
    mov r13.yzw, r13.xxxx  // r13.y <- shadow.x; r13.z <- shadow.y; r13.w <- shadow.z
  endif 

#line 654
  mul r6.xyz, r13.yzwy, icb[r9.w + 0].xyzx  // r6.x <- <ComputeShadow_id52 return value>.x; r6.y <- <ComputeShadow_id52 return value>.y; r6.z <- <ComputeShadow_id52 return value>.z

#line 780
  mul r6.xyz, r6.xyzx, cb2[r5.z + 27].xyzx
