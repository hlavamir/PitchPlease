...
*****     Stages      *****
***************************
@G    Vertex => 9bb66eb4e4c8f922895106f7fa4c56cf
//
...
//   float ClusterDepthScale_id178;     // Offset: 1636 Size:     4 [unused]
//   float ClusterDepthBias_id179;      // Offset: 1640 Size:     4 [unused]
//   float2 ClusterStride_id180;        // Offset: 1648 Size:     8 [unused]
//   float3 AmbientLight_id183;         // Offset: 1664 Size:    12 [unused]
...
//
#line 236 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_ShadowMapCaster_55282d927df2810f1363d6cd70eb9440.hlsl"
...
cbuffer PerMaterial 
{
    float4 InputValue_id185;
    float InputValue_id193;
    float InputValue_id202;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
Texture2D EnvironmentLightingDFG_LUT_id214;
