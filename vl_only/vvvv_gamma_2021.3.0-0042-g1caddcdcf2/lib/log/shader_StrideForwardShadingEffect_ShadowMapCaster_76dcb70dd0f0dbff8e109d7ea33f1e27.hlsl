...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<2>, ShadowMapReceiverDirectional<4,2,true,true,true,false>, ShadowMapFilterDefault<PerView.Lighting>, LightClusteredPointGroup, LightClusteredSpotGroup
...
@C    NearClipPlane_id165 => Camera.NearClipPlane
@C    FarClipPlane_id166 => Camera.FarClipPlane
@C    ZProjection_id167 => Camera.ZProjection
@C    ViewSize_id168 => Camera.ViewSize
@C    AspectRatio_id169 => Camera.AspectRatio
...
@C    ClusterDepthScale_id174 => LightClustered.ClusterDepthScale
@C    ClusterDepthBias_id175 => LightClustered.ClusterDepthBias
@C    ClusterStride_id176 => LightClustered.ClusterStride
...
@R    ShadowMapTexture_id87 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: None, Slot: (-1--1)]
@R    LightClusters_id172 => LightClustered.LightClusters [Stage: None, Slot: (-1--1)]
@R    LightClusters_id172 => LightClustered.LightClusters [Stage: None, Slot: (-1--1)]
@R    LightIndices_id173 => LightClustered.LightIndices [Stage: None, Slot: (-1--1)]
@R    LightIndices_id173 => LightClustered.LightIndices [Stage: None, Slot: (-1--1)]
@R    PointLights_id177 => LightClusteredPointGroup.PointLights [Stage: None, Slot: (-1--1)]
@R    PointLights_id177 => LightClusteredPointGroup.PointLights [Stage: None, Slot: (-1--1)]
@R    SpotLights_id178 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    SpotLights_id178 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
...
*****     Stages      *****
***************************
@G    Vertex => 3179bc30be532d94b60a30d8a86538d9
//
...
//   float NearClipPlane_id165;         // Offset:  352 Size:     4 [unused]
//      = 0x3f800000 
//   float FarClipPlane_id166;          // Offset:  356 Size:     4 [unused]
//      = 0x42c80000 
//   float2 ZProjection_id167;          // Offset:  360 Size:     8 [unused]
//   float2 ViewSize_id168;             // Offset:  368 Size:     8 [unused]
//   float AspectRatio_id169;           // Offset:  376 Size:     4 [unused]
...
//
//   } Lights_id86[2];                  // Offset:  416 Size:    60 [unused]
//   float2 ShadowMapTextureSize_id88;  // Offset:  480 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id89;// Offset:  488 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id151[8];// Offset:  496 Size:   512 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id152[8];// Offset: 1008 Size:   512 [unused]
//   float4x4 ViewMatrices_id153[8];    // Offset: 1520 Size:   512 [unused]
//   float2 DepthRanges_id154[8];       // Offset: 2032 Size:   120 [unused]
//   float DepthBiases_id155[2];        // Offset: 2160 Size:    20 [unused]
//   float OffsetScales_id156[2];       // Offset: 2192 Size:    20 [unused]
//   float CascadeDepthSplits_id163[8]; // Offset: 2224 Size:   116 [unused]
//   float ClusterDepthScale_id174;     // Offset: 2340 Size:     4 [unused]
//   float ClusterDepthBias_id175;      // Offset: 2344 Size:     4 [unused]
//   float2 ClusterStride_id176;        // Offset: 2352 Size:     8 [unused]
//   float3 AmbientLight_id179;         // Offset: 2368 Size:    12 [unused]
...
// SCREENPOSITION_ID164_SEM     0   xyzw        5     NONE   float   xyzw
//
vs_5_0
...
//   o5.x <- <VSMain return value>.ScreenPosition_id164.x; o5.y <- <VSMain return value>.ScreenPosition_id164.y; o5.z <- <VSMain return value>.ScreenPosition_id164.z; o5.w <- <VSMain return value>.ScreenPosition_id164.w; 
...
//
#line 233 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_ShadowMapCaster_76dcb70dd0f0dbff8e109d7ea33f1e27.hlsl"
...
***************************
*************************/
const static int TMaxLightCount_id85 = 2;
const static int TCascadeCountBase_id149 = 4;
const static int TLightCountBase_id150 = 2;
const static int TCascadeCount_id157 = 4;
const static int TLightCount_id158 = 2;
struct VS_STREAMS 
{
...
struct VS_OUTPUT 
{
    ...
    float4 ScreenPosition_id164 : SCREENPOSITION_ID164_SEM;
};
struct VS_INPUT 
{
...
cbuffer PerView 
{
    ...
    float4 Eye_id30;
    float NearClipPlane_id165 = 1.0f;
    float FarClipPlane_id166 = 100.0f;
    float2 ZProjection_id167;
    float2 ViewSize_id168;
    float AspectRatio_id169;
    ...
    float ClusterDepthScale_id174;
    float ClusterDepthBias_id175;
    float2 ClusterStride_id176;
...
Texture3D<uint2> LightClusters_id172;
Buffer<uint> LightIndices_id173;
Buffer<float4> PointLights_id177;
Buffer<float4> SpotLights_id178;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    VSMain_id19(streams);
    streams.ScreenPosition_id164 = streams.ShadingPosition_id0;
    ...
    __output__.ScreenPosition_id164 = streams.ScreenPosition_id164;
    return __output__;
}
