...
@C    NearClipPlane_id188 => Camera.NearClipPlane
@C    FarClipPlane_id189 => Camera.FarClipPlane
@C    ZProjection_id190 => Camera.ZProjection
@C    ViewSize_id191 => Camera.ViewSize
@C    AspectRatio_id192 => Camera.AspectRatio
...
@C    LightCount_id164 => DirectLightGroupPerView.LightCount.directLightGroups[1]
@C    Lights_id166 => LightDirectionalGroup.Lights.directLightGroups[1]
@C    ShadowMapTextureSize_id168 => ShadowMap.TextureSize.directLightGroups[1]
@C    ShadowMapTextureTexelSize_id169 => ShadowMap.TextureTexelSize.directLightGroups[1]
@C    WorldToShadowCascadeUV_id173 => ShadowMapReceiverBase.WorldToShadowCascadeUV.directLightGroups[1]
@C    InverseWorldToShadowCascadeUV_id174 => ShadowMapReceiverBase.InverseWorldToShadowCascadeUV.directLightGroups[1]
@C    ViewMatrices_id175 => ShadowMapReceiverBase.ViewMatrices.directLightGroups[1]
@C    DepthRanges_id176 => ShadowMapReceiverBase.DepthRanges.directLightGroups[1]
@C    DepthBiases_id177 => ShadowMapReceiverBase.DepthBiases.directLightGroups[1]
@C    OffsetScales_id178 => ShadowMapReceiverBase.OffsetScales.directLightGroups[1]
@C    CascadeDepthSplits_id185 => ShadowMapReceiverDirectional.CascadeDepthSplits.directLightGroups[1]
@C    ClusterDepthScale_id197 => LightClustered.ClusterDepthScale
@C    ClusterDepthBias_id198 => LightClustered.ClusterDepthBias
@C    ClusterStride_id199 => LightClustered.ClusterStride
...
@R    ShadowMapTexture_id87 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: None, Slot: (-1--1)]
@R    ShadowMapTexture_id167 => ShadowMap.ShadowMapTexture.directLightGroups[1] [Stage: None, Slot: (-1--1)]
@R    ShadowMapTexture_id167 => ShadowMap.ShadowMapTexture.directLightGroups[1] [Stage: None, Slot: (-1--1)]
@R    LightClusters_id195 => LightClustered.LightClusters [Stage: None, Slot: (-1--1)]
@R    LightClusters_id195 => LightClustered.LightClusters [Stage: None, Slot: (-1--1)]
@R    LightIndices_id196 => LightClustered.LightIndices [Stage: None, Slot: (-1--1)]
@R    LightIndices_id196 => LightClustered.LightIndices [Stage: None, Slot: (-1--1)]
@R    PointLights_id200 => LightClusteredPointGroup.PointLights [Stage: None, Slot: (-1--1)]
@R    PointLights_id200 => LightClusteredPointGroup.PointLights [Stage: None, Slot: (-1--1)]
@R    SpotLights_id201 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
@R    SpotLights_id201 => LightClusteredSpotGroup.SpotLights [Stage: None, Slot: (-1--1)]
...
*****     Stages      *****
***************************
@G    Vertex => 1ecd7c01fa0fc4631dc49988fa34ec25
//
...
//   float NearClipPlane_id188;         // Offset:  352 Size:     4 [unused]
//      = 0x3f800000 
//   float FarClipPlane_id189;          // Offset:  356 Size:     4 [unused]
//      = 0x42c80000 
//   float2 ZProjection_id190;          // Offset:  360 Size:     8 [unused]
//   float2 ViewSize_id191;             // Offset:  368 Size:     8 [unused]
//   float AspectRatio_id192;           // Offset:  376 Size:     4 [unused]
...
//   int LightCount_id164;              // Offset: 1380 Size:     4 [unused]
//   
//   struct DirectionalLightData
//   {
//       
...
//
//   } Lights_id166;                    // Offset: 1392 Size:    28 [unused]
//   float2 ShadowMapTextureSize_id168; // Offset: 1424 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id169;// Offset: 1432 Size:     8 [unused]
//   float4x4 WorldToShadowCascadeUV_id173[4];// Offset: 1440 Size:   256 [unused]
//   float4x4 InverseWorldToShadowCascadeUV_id174[4];// Offset: 1696 Size:   256 [unused]
//   float4x4 ViewMatrices_id175[4];    // Offset: 1952 Size:   256 [unused]
//   float2 DepthRanges_id176[4];       // Offset: 2208 Size:    56 [unused]
//   float DepthBiases_id177;           // Offset: 2272 Size:     4 [unused]
//   float OffsetScales_id178;          // Offset: 2288 Size:     4 [unused]
//   float CascadeDepthSplits_id185[4]; // Offset: 2304 Size:    52 [unused]
//   float ClusterDepthScale_id197;     // Offset: 2356 Size:     4 [unused]
//   float ClusterDepthBias_id198;      // Offset: 2360 Size:     4 [unused]
//   float2 ClusterStride_id199;        // Offset: 2368 Size:     8 [unused]
//   float3 AmbientLight_id202;         // Offset: 2384 Size:    12 [unused]
...
// SCREENPOSITION_ID187_SEM     0   xyzw        5     NONE   float   xyzw
//
vs_5_0
...
//   o5.x <- <VSMain return value>.ScreenPosition_id187.x; o5.y <- <VSMain return value>.ScreenPosition_id187.y; o5.z <- <VSMain return value>.ScreenPosition_id187.z; o5.w <- <VSMain return value>.ScreenPosition_id187.w; 
...
//
#line 242 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_ShadowMapCaster_85419e91fc7a79f16447f957f579da85.hlsl"
...
struct VS_OUTPUT 
{
    ...
    float4 ScreenPosition_id187 : SCREENPOSITION_ID187_SEM;
};
struct VS_INPUT 
{
...
cbuffer PerView 
{
    ...
    float4 Eye_id30;
    float NearClipPlane_id188 = 1.0f;
    float FarClipPlane_id189 = 100.0f;
    float2 ZProjection_id190;
    float2 ViewSize_id191;
    float AspectRatio_id192;
    ...
    int LightCount_id164;
    DirectionalLightData Lights_id166[TMaxLightCount_id85];
    float2 ShadowMapTextureSize_id168;
    float2 ShadowMapTextureTexelSize_id169;
    float4x4 WorldToShadowCascadeUV_id173[TCascadeCountBase_id149 * TLightCountBase_id150];
    float4x4 InverseWorldToShadowCascadeUV_id174[TCascadeCountBase_id149 * TLightCountBase_id150];
    float4x4 ViewMatrices_id175[TCascadeCountBase_id149 * TLightCountBase_id150];
    float2 DepthRanges_id176[TCascadeCountBase_id149 * TLightCountBase_id150];
    float DepthBiases_id177[TLightCountBase_id150];
    float OffsetScales_id178[TLightCountBase_id150];
    float CascadeDepthSplits_id185[TCascadeCount_id157 * TLightCount_id158];
    float ClusterDepthScale_id197;
    float ClusterDepthBias_id198;
    float2 ClusterStride_id199;
...
Texture2D ShadowMapTexture_id167;
Texture3D<uint2> LightClusters_id195;
Buffer<uint> LightIndices_id196;
Buffer<float4> PointLights_id200;
Buffer<float4> SpotLights_id201;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    VSMain_id19(streams);
    streams.ScreenPosition_id187 = streams.ShadingPosition_id0;
    ...
    __output__.ScreenPosition_id187 = streams.ScreenPosition_id187;
    return __output__;
}
