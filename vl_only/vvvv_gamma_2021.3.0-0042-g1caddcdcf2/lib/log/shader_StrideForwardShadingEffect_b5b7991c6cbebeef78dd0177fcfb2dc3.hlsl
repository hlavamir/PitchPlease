...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<2>, ShadowMapReceiverDirectional<4,2,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,5>, LightClusteredPointGroup, LightClusteredSpotGroup
...
//   float ClusterDepthScale_id177;     // Offset: 2340 Size:     4 [unused]
//   float ClusterDepthBias_id178;      // Offset: 2344 Size:     4 [unused]
//   float2 ClusterStride_id179;        // Offset: 2352 Size:     8 [unused]
//   float3 AmbientLight_id182;         // Offset: 2368 Size:    12 [unused]
...
//
#line 972 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_b5b7991c6cbebeef78dd0177fcfb2dc3.hlsl"
...
@G    Pixel => 76cef114d181f73f37c51f44dcfb24a0
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 ShadowMapTextureSize_id90;  // Offset:  480 Size:     8
...
//   float ClusterDepthScale_id177;     // Offset: 2340 Size:     4
//   float ClusterDepthBias_id178;      // Offset: 2344 Size:     4
//   float2 ClusterStride_id179;        // Offset: 2352 Size:     8
//   float3 AmbientLight_id182;         // Offset: 2368 Size:    12
//   float4 _padding_PerView_Lighting;  // Offset: 2384 Size:    16 [unused]
//
// }
//
...
//
#line 1039 "C:\Program Files\vvvv\vvvv_gamma_2021.3.0-0042-g1caddcdcf2\lib\log\shader_StrideForwardShadingEffect_b5b7991c6cbebeef78dd0177fcfb2dc3.hlsl"
...
#line 450
  mad r7.zw, r8.xxxy, cb2[30].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
...
#line 453
  mul r8.xy, r8.xyxx, cb2[30].zwzz

#line 314
  mad r9.xy, -r7.wzww, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r9.x <- uvW0.y; r9.y <- uvW0.x

#line 316
  mad r9.zw, r7.zzzw, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r9.z <- uvW2.x; r9.w <- uvW2.y
...
#line 318
  add r11.xy, r7.zwzz, l(3.000000, 3.000000, 0.000000, 0.000000)
  mul r10.yz, r11.yyxy, l(0.000000, 0.142857, 0.142857, 0.000000)  // r10.y <- uv1.y; r10.z <- uv1.x

#line 319
  div r7.zw, r7.zzzw, r9.zzzw
  add r11.xy, r7.zwzz, l(2.000000, 2.000000, 0.000000, 0.000000)  // r11.x <- uv2.x; r11.y <- uv2.y

#line 328
  mul r7.zw, r9.xxxw, r9.yyyz

#line 321
  mad r12.xyzw, r10.xwzw, cb2[30].zwzw, r8.xyxy
...
#line 324
  mad r14.xyzw, r10.xyzy, cb2[30].zwzw, r8.xyxy

#line 325
  mad r15.xyzw, r11.xzxw, cb2[30].zwzw, r8.xyxy
...
#line 327
  mad r10.xyzw, r10.xyzy, cb2[30].zwzw, r8.xyxy
  mul r11.zw, r9.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 328
  mad r8.xy, r11.xyxx, cb2[30].zwzz, r8.xyxx

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r12.xyxx, t0.xxxx, s0, r8.z  // r8.w <- <SampleTextureAndCompare_id60 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.z, r12.zwzz, t0.xxxx, s0, r8.z  // r9.z <- <SampleTextureAndCompare_id60 return value>

#line 504
  mul r9.z, r9.z, r13.x
  mad r7.z, r7.z, r8.w, r9.z  // r7.z <- shadow

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r15.xyxx, t0.xxxx, s0, r8.z  // r8.w <- <SampleTextureAndCompare_id60 return value>

#line 504
  mad r7.z, r9.x, r8.w, r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t0.xxxx, s0, r8.z

#line 504
  mad r7.z, r13.y, r8.w, r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t0.xxxx, s0, r8.z

#line 504
  mad r7.z, r8.w, l(49.000000), r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r15.zwzz, t0.xxxx, s0, r8.z

#line 504
  mad r7.z, r11.z, r8.w, r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r10.xyxx, t0.xxxx, s0, r8.z

#line 504
  mad r7.z, r9.y, r8.w, r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r10.zwzz, t0.xxxx, s0, r8.z

#line 504
  mad r7.z, r11.w, r8.w, r7.z

#line 445
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r8.xyxx, t0.xxxx, s0, r8.z  // r8.x <- <SampleTextureAndCompare_id60 return value>

#line 504
  mad r7.z, r7.w, r8.x, r7.z

#line 506
  mul r8.xyz, r7.zzzz, l(0.006944, 0.006944, 0.006944, 0.000000)  // r8.z <- shadow
...
#line 450
      mad r2.xy, r2.xyxx, cb2[30].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
      round_ni r7.yw, r2.xxxy  // r7.y <- base_uv.x; r7.w <- base_uv.y

#line 451
      add r2.xy, r2.xyxx, -r7.ywyy  // r2.x <- st.x; r2.y <- st.y

#line 452
      add r7.yw, r7.yyyw, l(0.000000, -0.500000, 0.000000, -0.500000)

#line 453
      mul r7.yw, r7.yyyw, cb2[30].zzzw
...
#line 321
      mad r12.xyzw, r10.xwzw, cb2[30].zwzw, r7.ywyw
...
#line 324
      mad r14.xyzw, r10.xyzy, cb2[30].zwzw, r7.ywyw

#line 325
      mad r15.xyzw, r11.xzxw, cb2[30].zwzw, r7.ywyw
...
#line 327
      mad r10.xyzw, r10.xyzy, cb2[30].zwzw, r7.ywyw
      mul r11.zw, r9.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 328
      mad r7.yw, r11.xxxy, cb2[30].zzzw, r7.yyyw
...
#line 445
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.z, r7.ywyy, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id60 return value>
...
#line 682
mul r0.xyz, cb1[0].xyzx, cb2[148].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id171 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id171 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id171 return value>.z
